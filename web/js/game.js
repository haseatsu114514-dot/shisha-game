...
const DATE_INVITE_LINES = {
  ...
  mashiro: ["……はじめくん……", "今日、いい葉が入った……見にこない……？", "……というのは口実で、会いたいだけ……です"],
};
const DATE_DECLINE_LINES = {
  ...
  mashiro: "……ん、わかった……むりしないでね……",
};

// 恋人からの朝LIME（Y5・2026-07-19）: 「恋人成立後は朝LIMEの文面が変わる」（story正本）の実装。
// 2日おきに他愛ない一言が届き、返信で絆が少し深まる。m=本文、r=返信選択肢
const LOVER_LIME_PHASE = { tsumugi: 0, minto: 1, rin: 0, ageha: 1, mashiro: 0 };
const LOVER_MORNING_LIMES = {
  tsumugi: [
    { m: ["……おはよう、ございます", "今日の朝の空、はじめさんの煙の色でした", "……それだけ、です"],
      r: [ { text: "今日の色、あとで教えて", response: "……はい。……ちゃんと、見ておきます", affinity: 1 },
           { text: "俺も同じ空を見てた", response: "……っ。……いい朝、です", affinity: 1 } ] },
    { m: ["……ゆうべ、二人のページ、少し進みました", "……見せるのは、まだ、だめです"],
      r: [ { text: "完成、楽しみにしてる", response: "……はい。……ゆっくり、描きます", affinity: 1 },
           { text: "ちょっとだけ見たい", response: "……だめ、です。……ちょっとだけも、だめ", affinity: 1 } ] },
    { m: ["……今日、tonariに行きます", "……お仕事のじゃまは、しません。……見てるだけ、です"],
      r: [ { text: "じゃまじゃないよ。待ってる", response: "……はい。……いちばん奥の席に、います", affinity: 1 },
           { text: "君がいると頑張れる", response: "……それ、ずるい、です。……がんばってください", affinity: 1 } ] },
  ],
  minto: [
    { m: ["おはよ、はじめくん", "……起きてすぐ、はじめくんのこと考えてた私、ちょっとやばいかも", "……今のは『みんと』じゃなくて、栞のほうね"],
      r: [ { text: "俺も考えてた", response: "……っ、朝からそういうこと言わないの。……うれしいけど", affinity: 1 },
           { text: "どっちの声も好きだよ", response: "……もう。……今日一日、それで生きていける", affinity: 1 } ] },
  ...
  rin: [
    { m: ["モルモットくん、おはよう", "今朝のコーヒー、君の煙に合いそうな豆だった", "……それだけ。仕事に戻る"],
      r: [ { text: "今度一緒に飲みましょう", response: "……予定に入れておく。最優先で", affinity: 1 },
           { text: "朝から俺のこと考えてました？", response: "……データの整理をしてただけ。……そういうことにしておいて", affinity: 1 } ] },
    { m: ["業務連絡。新しいサンプルが届いた", "……というのは口実で。顔が見たいだけ。……今日、時間ある？"],
      r: [ { text: "口実、要らないですよ", response: "……知ってる。でも私には、まだ要るの。……待ってる", affinity: 1 },
           { text: "サンプルも楽しみにしてます", response: "ん。君の感想が、いちばんのデータだから", affinity: 1 } ] },
    { m: ["……ゆうべ、君の煙の香りの再現配合を考えてた", "気づいたら3時。……ばかみたいでしょ", "責任、取ってよね"],
      r: [ { text: "本物をいつでも作りますよ", response: "……それ言われると配合の意味がないんだけど。……作って", affinity: 1 },
           { text: "ちゃんと寝てください", response: "……はい。……君のそういうとこ、ずるいと思う", affinity: 1 } ] },
  ],
  ageha: [
    { m: ["すきぴおはよ！！", "今日の占い、煙色がラッキーカラーだって！勝ち確じゃん！", "バイブス上げてこ！！"],
      r: [ { text: "あげはも今日かわいい（まだ見てないけど）", response: "見てないのに当てんなし！！……正解だけど♡", affinity: 1 },
           { text: "今日も頑張ろう", response: "おー！！夜、顔見せてよね！充電させて！", affinity: 1 } ] },
    { m: ["ねえ聞いて、夢にハジメっち出てきた", "夢の中でも煙作ってたわ。どんだけ〜", "……ってことで朝から会いたくなりました。以上！"],
      r: [ { text: "俺も会いたい", response: "即レス！！すきぴの鑑！！夜、店おいで♡", affinity: 1 },
           { text: "夢の俺、うまく作れてた？", response: "ガチうまそうだった！悔しいから現実でも作って！", affinity: 1 } ] },
    { m: ["朝のルーティン報告！", "①起きる ②ハジメっちにLIME ③かわいくなる", "今②！見て、この優先順位！"],
      r: [ { text: "③はもう完成してるでしょ", response: "〜〜っ！！朝からきゅん語録やめて！！好（ハオ）！！", affinity: 1 },
           { text: "俺は②の返信が①だよ", response: "それもう両想いの証明じゃん……ガチ幸せだわ", affinity: 1 } ] },
  ],
  mashiro: [
    { m: ["……おはよ……", "はじめくんの煙のにおいの夢、みた……", "……いい夢だった……以上……"],
      r: [ { text: "おはよう。二度寝しないで", response: "……善処する……えへへ", affinity: 1 },
           { text: "今日、本物を作るよ", response: "……たのしみ……起きる理由ができた……", affinity: 1 } ] },
    { m: ["……れんらく……", "今日の僕、ちゃんと起きた……えらい……", "……ほめて……"],
      r: [ { text: "えらい", response: "……えへへ……今日もがんばれる……", affinity: 1 },
...
function limeDueMessages(tournamentDay) {
  ...
  if (!tournamentDay) {
    for (const id of state.lovers || []) {
      const pool = LOVER_MORNING_LIMES[id];
      if (!pool || !pool.length) continue;
      if (chapterInfo().stageDays[state.day]) continue;
      if ((state.day + (LOVER_LIME_PHASE[id] || 0)) % 2 !== 0) continue; // 2日おき・キャラごとに位相をずらす
      const msgId = `_lover_morning_${id}_d${state.day}`;
      if (state.limeDone.includes(msgId)) continue;
      const v = pool[Math.floor((state.day + (LOVER_LIME_PHASE[id] || 0)) / 2) % pool.length];
...
// 各キャラ複数パターンを日付でローテ（毎日会っても同じ台詞にならない・Y5）
const LOVER_QUICK_LINES = {
  tsumugi: [
    ["……顔、見れた。それだけで、今日はいい日です", "（隣に座って、しばらく同じ煙を見ていた。）"],
    ["……今日の色、あとで描いて、見せますね", "（iPadの画面を、少しだけ見せてくれた。）"],
    ["……手、つないでも、いいですか。……少しだけ", "（「少しだけ」が、結構長かった。嬉しかった。）"],
  ],
  minto: [
    ["……えへへ。来てくれた。……それだけで、その、うれしい……", "（手をつなぐだけの、短い時間だった。）"],
    ["来てくれた♡ ……お客さんの前だから、これ以上はダメ", "（指先だけ、こっそり触れて離れた。）"],
    ["……ん。元気そうな顔。……よし、今日も頑張れる", "（営業スマイルじゃない笑顔を、一瞬だけもらった。）"],
  ],
  rin: [
    ["なに、顔見に来ただけ？　……ふうん。悪くない習慣ね", "（5分だけ、と言いながら、コーヒーを出してくれた。）"],
    ["……ちょうどいいところに。この香り、感想ちょうだい", "（仕事にかこつけて、隣の椅子を勧められた。）"],
    ["顔を見ると集中が切れる。……来なくていいとは、言ってない", "（素直じゃない言い方に、少し笑ってしまった。）"],
  ],
  ageha: [
    ["きた！！すきぴの顔！今日もかわちい！", "（写真を3枚撮られた。「待ち受けにする」らしい。）"],
    ["ハジメっち充、完了！！これで夜まで生きられるわ", "（充電器扱いだった。悪い気はしない。）"],
    ["ちょうど新作できたとこ！一口だけ！はい口あけて！", "（あーんの体勢から、逃げられなかった。）"],
  ],
  mashiro: [
    ["……はじめくんだ……えへへ、ほんものだ……", "（三秒くらい、袖をつままれていた。）"],
    ["……ちょうど、いい煙ができたとこ……一口どうぞ", "（回ってきたホースが、ほんのり甘かった。）"],
  ],
};
function loverQuickMeet(charId) {
  state.loverQuickDay = state.day;
  dateContext = true;
  const pool = LOVER_QUICK_LINES[charId];
  const lines = pool ? pool[(state.day + (state.visits[charId] || 0)) % pool.length] : ["少しだけ、顔を見て話した。"];
  playCustom({
