# Gemini キャラクター立ち絵プロンプト集

全キャラクター共通ルール:
- **全身立ち絵**（full body standing sprite）
- **ホース・シーシャ本体・道具類は持たせない**
- **背景: 白背景（white background）または透過**
- **等身: 6頭身で統一**（6-head-height body proportions）
- **スタイル: セミリアル系アニメイラスト**、クリーンな線画＋セルシェーディング

---

## ベーススタイルプロンプト（全キャラ共通・先頭に必ず付ける）
...
**設定反映ポイント:** 素直で天然、自分では気づかない人たらし。誰のことも素直に認める温かみ。でも誰かを馬鹿にされると静かに燃える強さがある。
...
**設定反映ポイント:** かつての名プレイヤー。今は飄々と地元店を営む。基本に忠実かつ自由。南雲会長とは旧友でライバル関係。
...
**設定反映ポイント:** tonari常連。内向的だが芯がある。タブレット（デザインやメモに使っている）をよく持ち歩く。シャイだけど自分の好みははっきりしている。
...
**設定反映ポイント:** コンカフェ「ぺぱーみんと」No.1キャスト。完璧に計算された小悪魔キャラ。客の視線と心理を読みきった戦略眼を持つ。笑顔の裏に大人の切実さ。
...
- 塗り: セルシェーディング＋柔らかいグラデーション影
- テクスチャ: 服のシワがリアル寄り
- 目: 半リアル系（虹彩の描き込みあり）
- 背景: 完全白（透過可）

最新のスミさん（ChatGPT 2月26日版）の画風:
- ピクセルアート×アニメのハイブリッド
- 暗めのバー背景＋ネオン
- 最終的な統一先の目標スタイル
