...
- **性格アーク（2026-06-10改定）**: 序盤は名店tonariの看板を笠に着て調子に乗っており、夢は「自分の店を持つ」（中身のない薄い夢）。カーズ／TOD2カイル型。全国で勝ち続けた果てに**味覚を失い・仲間に見放され**（テイルズオブジアビス型）、ch3でましろだけに救われて素直さが本物になる。詳細は `brand/story_and_structure.md`
- ⚠️ 「客観視」「客を見る力」「フラットさ」は**廃止済みの旧設定**。コード・セリフ・設定に使わないこと。
- ⚠️ 「自信がない・謙虚な主人公」も**旧設定**。序盤のはじめは調子乗りである。
